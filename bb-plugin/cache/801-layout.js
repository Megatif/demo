...
jQuery(function($) {
	var owl = $(".owl-carousel_5f280d2610f2b");
			owl.owlCarousel({
				rtl: parseInt(""),
				margin: 0,
				nav: 0,
...
jQuery(function($) {
	...
	$("#5f280e7f61d96 ul.sub_categories_list li a").on("click",function() {
		catID = $(this).attr("data-catid");
		page= 1 ;
		load_posts();
	});
	
	$("#5f280e7f61d96").on("click", "ul.pagination-list li a",function() {
	...
	function load_posts() {
		$.ajax({
			...
			success: function( response ) {
				...
				$( '#5f280e7f61d96 div.section-content' ).html('');
				$( '#5f280e7f61d96 div.posts-pagination' ).html( pagination==null?"":pagination ); 

				secondary_articles.forEach(function(elem) {
					$( '#5f280e7f61d96 div.section-content' ).append( elem );
				});

				$("#5f280e7f61d96 .secondary-article-title a,#5f280e7f61d96 .big-article-title a").each(function(){
				...
				$("#5f280e7f61d96 #overlay").fadeOut(300);
				$("#5f280e7f61d96").animate({opacity: 1}, 500);            
