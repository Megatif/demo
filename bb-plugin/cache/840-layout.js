...
jQuery(function($) {
	var owl = $(".owl-carousel_5f2886088b389");
			owl.owlCarousel({
				rtl: parseInt(""),
				margin: 0,
				nav: 0,
...
jQuery(function($) {
	...
	$("#5f287b697cb6e ul.sub_categories_list li a").on("click",function() {
		catID = $(this).attr("data-catid");
		page= 1 ;
		load_posts();
	});
	
	$("#5f287b697cb6e").on("click", "ul.pagination-list li a",function() {
	...
	function load_posts() {
		$.ajax({
			...
			success: function( response ) {
				...
				$( '#5f287b697cb6e div.section-content' ).html('');
				$( '#5f287b697cb6e div.posts-pagination' ).html( pagination==null?"":pagination ); 

				secondary_articles.forEach(function(elem) {
					$( '#5f287b697cb6e div.section-content' ).append( elem );
				});

				$("#5f287b697cb6e .secondary-article-title a,#5f287b697cb6e .big-article-title a").each(function(){
				...
				$("#5f287b697cb6e #overlay").fadeOut(300);
				$("#5f287b697cb6e").animate({opacity: 1}, 500);            
